...
// Sets default values
ABulletBillBottom::ABulletBillBottom()
{
 	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;

	BoxComponent = CreateDefaultSubobject<UBoxComponent>("BulletBillBottomComponent");
...
void ABulletBillBottom::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ABulletBillBottom::Tick(float DeltaTime)
{
